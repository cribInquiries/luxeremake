  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <p className="text-xl text-gray-600 mb-12">{property.shortDescription}</p>
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <p>
            This property underwent a complete transformation, becoming a showcase of modern design and luxury living.
          </p>
        </div>
      </div>
    </div>
