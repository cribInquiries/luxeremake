  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <p className="text-xl text-gray-600 mb-12">Glenelg Transformation - A Beachside Success Story</p>
        ...
        <div className="prose prose-lg max-w-none">
          <p>
            Transforming this Glenelg property into a premier short-term rental destination showcases the power of
